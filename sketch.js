...
mango = new Mango(680, 330, 20, 40)
mango1 = new Mango(740, 330, 20, 40)
mango2 = new Mango(620, 330, 20, 40)
mango3 = new Mango(560, 330, 20, 40)

mango4 = new Mango(740, 280, 20, 40)
mango5 = new Mango(680, 280, 20, 40)
mango6 = new Mango(620, 280, 20, 40)

mango7 = new Mango(740, 230, 20, 40)
mango8 = new Mango(680, 230, 20, 40)

mango9 = new Mango(740, 180, 20, 40)
